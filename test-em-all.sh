...
# curl option
## k: allow http
## s: no print processing output
## o > -o FILE: write respose in FILE
function assertCurl() {
  ...
  ## &&: Run Command when previous result is true
...
# docker compose run when script args contain 'start'
if [[ $@ == *"start"* ]]
then
...
# docker-compose down when varagrs contain 'stop'
if [[ $@ == *"stop"* ]]
then
